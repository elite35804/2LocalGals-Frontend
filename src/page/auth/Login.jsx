    ...
    <div className="login_page h-screen">
      <div className="2xl:max-w-[400px] w-full max-w-[350px] mx-auto h-full justify-center flex flex-col gap-2">
        <div className="text-center">
          <div className="flex justify-center">
            <img
              ...
              src="https://scontent.fixc1-7.fna.fbcdn.net/v/t39.30808-6/277778836_401580788636662_7687958163370346394_n.png?_nc_cat=103&ccb=1-7&_nc_sid=5f2048&_nc_ohc=n1rh91JcfWYQ7kNvgGwO6FN&_nc_ht=scontent.fixc1-7.fna&oh=00_AYAZlM9hpL2MmcpYjioCEOWf9GKvHu85F0bceQfYC-AT5g&oe=6669ECD3"
              alt=""
            />
          </div>
          <h2 className="font-semibold text-white text-2xl heading mt-3">
            Welcome
          </h2>
        </div>
        <h2 className="font-bold text-white text-lg heading mt-8">
        ...
        <form className="flex flex-col mt-2" onSubmit={onSubmit}>
          ...
          <div className="2xl:p-4 bg-white border-input-placeholder flex items-center gap-x-2 rounded-xl p-4 relative mt-4">
            ...
            <input
              ...
              id="password"
            />
            <VisibilityIcon sx={{ fontSize: "15px", color: "#747474" }} className="cursor-pointer" />
          </div>
          {/* <p className="text-[11px] my-2 mr-2 text-input-placeholder w-max ml-auto" >Forgot Password ?</p> */}
          <button
            type="submit"
            className="sign-in text-center mt-10 bg-yellow-900 text-white text-xs font-semibold px-12 py-3 rounded-lg"
          >
